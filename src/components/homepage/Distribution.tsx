    ...
    <>
      ...
      >
        ...
        <div className="w-full md:w-1/3 hidden md:flex flex flex-col items-center md:items-start justify-center text-center md:text-left mt-8 md:mt-0">
          ...
          >
            Our training dataset is carefully curated to ensure balanced
            representation across all major emotions. This even distribution
            helps the model avoid bias and perform consistently, no matter the
            scenario.
          </div>
