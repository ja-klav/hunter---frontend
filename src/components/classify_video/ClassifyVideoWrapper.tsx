...
import { useClassifyVideo } from "../../hooks/useClassifyVideo";
import ScratchClassifyVideo from "./ScratchClassifyVideo";
import PreviewClassifyVideo from "./PreviewClassifyVideo";
import { motion, AnimatePresence } from "framer-motion";
import { AiOutlineLoading3Quarters } from "react-icons/ai";

function ClassifyVideoWrapper() {
  const {
    selectedFile,
    preview,
    loading,
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center px-3 md:px-36">
      ...
      >
        Classify Emotion from Video
      </motion.div>

      <div className="mt-4 text-gray-300 text-sm md:text-md">
        Upload a video and let AI detect emotions frame by frame.
      </div>
...
export default ClassifyVideoWrapper;